...
namespace rs
{
    ...
    void showCapMessage(al::IUseSceneObjHolder const*, char const*, int, int);
    void showCapMessageDemo(al::IUseSceneObjHolder const*, char const*, int, int);
    void showCapMessageEnterExStage(al::IUseSceneObjHolder const*, char const*, int, int);
